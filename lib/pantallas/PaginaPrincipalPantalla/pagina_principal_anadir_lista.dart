...
class PaginaPrincipalAnadirLista extends StatefulWidget {
  ...
  @override
  _PaginaPrincipalAnadirListaState createState() => _PaginaPrincipalAnadirListaState();
}

class _PaginaPrincipalAnadirListaState extends State<PaginaPrincipalAnadirLista> {
