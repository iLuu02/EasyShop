...
import 'package:proyecto_moviles/modelos/lista_listasCompra.dart';
...
import '../../patron_orden/UndoManager.dart';
import '../../util/util.dart';
import '../ListaCompraPantalla/lista_compra_pantalla.dart';

class PaginaPrincipalPantallaLlena extends StatelessWidget {

  const PaginaPrincipalPantallaLlena({Key? key, required this.listasDeCompra, required this.color}) : super(key: key);
        ...
        itemBuilder: (BuildContext context, index) {
          ...
          return Padding(
            ...
            child:  Dismissible(
              ...
              direction: DismissDirection.endToStart, // Aquí establecemos que solo se permita de derecha a izquierda
              ...
              confirmDismiss: (DismissDirection direction) async {
                if (direction == DismissDirection.endToStart) {
                  ...
                  mostrarSnackBarEliminarLista(context,listaIndividual, listasDeCompra);
                }
              },
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.of(context).push(
                      _createRoute(listaIndividual, listasDeCompra));
                },
                child: Row(
  ...
  Widget construirMenuDesplegable(BuildContext context, ListaCompra listaIndividual, int index) {
...
Route _createRoute(ListaCompra listaCompra, ListaListasCompra listasDeCompra) {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => ListaCompraPantalla(listaCompra: listaCompra, listasDeCompra: listasDeCompra),
...
void mostrarSnackBarEliminarLista(BuildContext context, ListaCompra listaIndividual, ListaListasCompra lista) {
