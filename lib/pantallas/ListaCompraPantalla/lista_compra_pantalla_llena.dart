...
import '../../modelos/lista_listasCompra.dart';
...
class ListaCompraPantallaLlena extends StatelessWidget {
  const ListaCompraPantallaLlena({Key? key, required this.listaCompra, required this.listasDeCompra, required this.color})
      : super(key: key);
