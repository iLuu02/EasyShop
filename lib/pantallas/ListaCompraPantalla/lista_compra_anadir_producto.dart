...
class _ListaCompraAnadirProductoState extends State<ListaCompraAnadirProducto> {
  ...
  Widget construyeCampoCategoria() {
    ...
    if (_categoriaSeleccionada == null || !categorias.contains(_categoriaSeleccionada)) {
      ...
      children: <Widget>[
        ...
        Center(
          child: ElevatedButton(
            ...
            style: ButtonStyle(
              backgroundColor: MaterialStateProperty.all<Color>(widget.colorTema), // Color de fondo del botón
            ),
