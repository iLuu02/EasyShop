...
class AnadirCategoriaPantalla extends StatefulWidget {
  Color color;
  AnadirCategoriaPantalla({Key? key, required this.color})
      : super(key: key);
  @override
  _AnadirCategoriaPantallaState createState() => _AnadirCategoriaPantallaState();
}

class _AnadirCategoriaPantallaState extends State<AnadirCategoriaPantalla> {
